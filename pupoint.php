				...
				<div>
					...
					<div class="widget-body no-padding">
                                            ...
                                            <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                                                    <thead>
                                                        <!--<tr>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="รหัสสินค้า" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="รหัสสินค้า ex" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="ชื่อสินค้า" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="ประเภทสินค้า" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="ชนิดสินค้า" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="onhand" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="Pu Piont" /></th>
                                                            <th class="hasinput" style="width:17%"><input type="text" class="form-control" placeholder="Pu Period" /></th>
                                                        </tr>-->
                                                        <tr>
